...
// 站点版本信息（store 优先，fallback 到 themeConfig）
const displaySiteVersion = computed(() => store.siteVersion || theme.siteVersion);
const displaySiteVersionDate = computed(() => store.siteVersionDate || theme.siteVersionDate);
