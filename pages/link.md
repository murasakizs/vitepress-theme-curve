...
- 名称：`泠の小站`
- 描述：`一个莫名其妙的小站（？）`
- 地址：`https://sgexilq.com/`
- 头像：`https://sgexilq.com/images/logo/favicon-256.png`
- 站点图片：`麻烦自行拍摄（不加也行`
...
avatar: https://sgexilq.com/images/logo/favicon-256.png
screenshot: 麻烦自行拍摄（不加也行
```

### 申请友链

- 我已添加 [泠の小站](https://sgexilq.com/) 的友情链接。
